...
1. Прямой доступ сайта и онлайн-банка к базе данных АБС <br> Не изменять реализацию, при которой доступ к данным напрямую из пользовательских интерфейсов (сайта и онлайн-банка) к базе данных АБС <br>
   * Плюсы:
...
2. Оставить логику уведомлений в ядре системы АБС
   * Плюсы:
     * Отсутствие доработок
     * Минимум новых компонентов
   * Минусы
     * Увелечение затрат на обслуживание сервиса уведомлений
